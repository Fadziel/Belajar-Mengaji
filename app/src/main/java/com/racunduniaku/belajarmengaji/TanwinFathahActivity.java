...
public class TanwinFathahActivity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        ButtonSuara14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_shon);
                TampilGambar.startAnimation(animScale);
                SuaraShad.start();
            }
        });
        ...
        ButtonSuara15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_dhon);
                TampilGambar.startAnimation(animScale);
                SuaraDod.start();
            }
        });
        ButtonSuara16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_thon);
                TampilGambar.startAnimation(animScale);
                SuaraTo.start();
            }
        });
        ...
        ButtonSuara18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_ngan);
                TampilGambar.startAnimation(animScale);
                SuaraAin.start();
            }
        });
        ...
        ButtonSuara19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_ghon);
                TampilGambar.startAnimation(animScale);
                SuaraGin.start();
            }
        });
        ...
        ButtonSuara21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_qon);
                TampilGambar.startAnimation(animScale);
                SuaraKof.start();
            }
        });
        ...
        ButtonSuara24.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatahtain_man);
                TampilGambar.startAnimation(animScale);
                SuaraMim.start();
            }
        });
    ...
    public void btnback(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), Tanwin.class);
