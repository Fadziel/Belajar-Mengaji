...
public class HarokatFathahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonSuara10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_ro);
                TampilGambar.startAnimation(animScale);
                SuaraRo.start();
            }
        });
        ...
        ButtonSuara14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_sho);
                TampilGambar.startAnimation(animScale);
                SuaraShad.start();
            }
        });
        ...
        ButtonSuara15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_dho);
                TampilGambar.startAnimation(animScale);
                SuaraDod.start();
            }
        });
        ButtonSuara16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_tho);
                TampilGambar.startAnimation(animScale);
                SuaraTo.start();
            }
        });
        ButtonSuara17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_dzo);
                TampilGambar.startAnimation(animScale);
                SuaraDo.start();
            }
        });
        ButtonSuara18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_aa);
                TampilGambar.startAnimation(animScale);
                SuaraAin.start();
            }
        });
        ...
        ButtonSuara19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_gho);
                TampilGambar.startAnimation(animScale);
                SuaraGin.start();
            }
        });
        ...
        ButtonSuara21.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_qo);
                TampilGambar.startAnimation(animScale);
                SuaraKof.start();
            }
        });
        ...
        ButtonSuara23.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_lam);
                TampilGambar.startAnimation(animScale);
                SuaraLam.start();
            }
        });
        ...
        ButtonSuara24.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_mim);
                TampilGambar.startAnimation(animScale);
                SuaraMim.start();
            }
        });
        ButtonSuara25.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                TampilGambar.setImageResource(R.drawable.pop_fatah_nun);
                TampilGambar.startAnimation(animScale);
                SuaraNun.start();
            }
        });
    ...
    public void btnback(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), Harokat.class);
